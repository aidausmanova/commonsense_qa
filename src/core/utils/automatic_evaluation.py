...
def single_reference_bleurt(df, temp_dir):
    ...
    for choice in selected_choices:
        ...
        # bleurt_command = f"python -m bleurt.score_files -candidate_file={temp_dir}/candidates -reference_file={temp_dir}/references-{choice} -bleurt_checkpoint=bleurt/bleurt-base-128 -scores_file={temp_dir}/scores-{choice}"
        # bleurt_command = f"python -m bleurt.score_files -candidate_file={temp_dir}/candidates -reference_file={temp_dir}/references-{choice} -bleurt_checkpoint=/export/home/0usmanov/bleurt/BLEURT-20 -scores_file={temp_dir}/scores-{choice}"
        bleurt_command = f"python -m bleurt.score_files -candidate_file={temp_dir}/candidates -reference_file={temp_dir}/references-{choice} -scores_file={temp_dir}/scores-{choice}"
